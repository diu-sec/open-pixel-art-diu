# DIU Open Pixel Art by DIU SEC
## Originally Created by [Twilio](https://www.twilio.com)
...
Visit [open-pixel-art-diu](https://diu-sec.github.io/open-pixel-art-diu) to see the full artwork!
...
> If you are new to open-source, GitHub or git in general, fear not, we created a tutorial in [DIU Terminal Quest](https://github.com/diu-sec/terminalquest) for you. It will teach you step by step on how you can get started and will guide you on your quest of creating your pull request.
> 🕹 [Download DIU Terminal Quest](https://github.com/diu-sec/terminalquest/releases)

The entire project is automated and is largely maintained by a set of bots that will verify any pixel contributions. However, if you'd like to know more about the project or submit other contributions to the project that are not a pixel, feel free to create a [GitHub issue](https://github.com/diu-sec/open-pixel-art-diu/issues) inside the [Open Pixel Art project](https://github.com/diu-sec/open-pixel-art-diu).

## Contributing

In order to contribute a pixel to the canvas, you'll have to create a [pull request](https://opensource.guide/how-to-contribute/#opening-a-pull-request) to the [Open Pixel Art project on GitHub](https://github.com/diu-sec/open-pixel-art-diu).
...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="https://github.com/simeydk"><img src="https://avatars0.githubusercontent.com/u/13088589?v=4" width="80px;" alt="Simey de Klerk"/><br /><sub><b>Simey de Klerk</b></sub></a><br /><a href="https://github.com/diu-sec/open-pixel-art-diu/commits?author=simeydk" title="Code">💻</a></td>
    ...
    <td align="center"><a href="https://gitlab.com/dpeukert"><img src="https://avatars2.githubusercontent.com/u/3451904?v=4" width="80px;" alt="Daniel Peukert"/><br /><sub><b>Daniel Peukert</b></sub></a><br /><a href="https://github.com/diu-sec/open-pixel-art-diu/commits?author=dpeukert" title="Documentation">📖</a></td>
  </tr>
  <tr>
    <td align="center"><a href="https://github.com/izontm"><img src="https://avatars1.githubusercontent.com/u/860741?v=4" width="80px;" alt="izontm"/><br /><sub><b>izontm</b></sub></a><br /><a href="https://github.com/diu-sec/open-pixel-art-diu/commits?author=izontm" title="Documentation">📖</a></td>
    <td align="center"><a href="https://github.com/carlyrobison"><img src="https://avatars1.githubusercontent.com/u/7573501?v=4" width="80px;" alt="Carly Robison"/><br /><sub><b>Carly Robison</b></sub></a><br /><a href="https://github.com/diu-sec/open-pixel-art-diu/commits?author=carlyrobison" title="Documentation">📖</a></td>
  </tr>
</table>
